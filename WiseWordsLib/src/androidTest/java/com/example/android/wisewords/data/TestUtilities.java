...
public class TestUtilities extends AndroidTestCase {
  ...
  public static final long TEST_DATE = 1476882608000L;
  ...
  static long insertTestQuoteValues(Context context) {
    ...
    long locationRowId;
    locationRowId = db.insert(QuoteContract.QuoteEntry.TABLE_NAME, null, testValues);
    // Verify we got a row back.
    assertTrue("Error: Failure to insert test quote values", locationRowId != -1);
